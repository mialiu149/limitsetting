...
INDIR=/home/users/mliu/CMSSW_7_4_7/src/limitsetting_whmet/cards_moriond17_v14
OUTDIR=limits_moriond17_tmp
...
#need to combine cards from multiple signal regions if necessaryfor i in "${samples[@]}"
for i in "${samples[@]}"
do
